...
from examples.test_dep_key import my_app as app_call
...
if __name__ == "__main__":
    ...
    app_call_result = asyncio.run(app_call.my_key(POS_VALUE, regular_value=KEY_VALUE))

    print(f"{simple_call_result=}")
    print(f"{custom_request_call_result=}")
    print(f"{app_call_result=}")
