...
if __name__ == "__main__":
    ...
    container_with_callback_map_result = asyncio.run(
        container.callback_map["my_key"](POS_VALUE, regular_value=KEY_VALUE)
    )

    print(f"{simple_call_result=}")
    print(f"{custom_request_call_result=}")
    print(f"{container_with_callback_map_result=}")
